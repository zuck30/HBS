                ...
                <div className="flex flex-wrap gap-4">
                  {section.points.map((point, j) => (
                    <div key={j} className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-[#44ACFF]/5 flex items-center justify-center">
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="bg-white rounded-[40px] border border-neutral-200 p-10 shadow-xl relative overflow-hidden">
             <div className="absolute top-0 right-0 w-32 h-32 bg-[#ECB65F]/10 rounded-bl-[100px]" />
