    ...
    <main className="pt-16 bg-[#f6f5f1] min-h-screen font-sans">
      <section className="py-24 px-6 border-b border-neutral-200 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center gap-6">
          ...
          <h1 className="text-4xl md:text-7xl font-bold text-[#000080] uppercase leading-[0.9] max-w-4xl">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-5 flex flex-col gap-12">
            <div className="flex flex-col gap-8">
              <div className="flex gap-6 group">
                <div className="w-12 h-12 rounded-2xl bg-[#000080] text-[#D4AF37] flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                  <MapPin className="w-6 h-6" />
                </div>
                <div className="flex flex-col gap-2">
                  <h4 className="text-sm font-bold text-[#000080] uppercase tracking-widest">Visit us</h4>
                  <p className="text-sm text-neutral-500 font-medium leading-relaxed">
                    140 Kimbiji Road, 17106 Mji Mwema, Dar es Salaam, Tanzania.
                  </p>
                  <a href="https://maps.google.com/?q=Hannah+Bennie+Schools" target="_blank" className="text-xs font-bold text-[#D4AF37] uppercase tracking-widest underline underline-offset-4">View on Google Maps →</a>
                </div>
              </div>
              ...
              <div className="flex gap-6 group">
                ...
                <div className="flex flex-col gap-2">
                  <h4 className="text-sm font-bold text-[#000080] uppercase tracking-widest">Call us</h4>
              ...
              <div className="flex gap-6 group">
                ...
                <div className="flex flex-col gap-2">
                  <h4 className="text-sm font-bold text-[#000080] uppercase tracking-widest">Email us</h4>
              ...
              <div className="flex gap-6 group">
                ...
                <div className="flex flex-col gap-2">
                  <h4 className="text-sm font-bold text-[#000080] uppercase tracking-widest">Office hours</h4>
            ...
            <div className="bg-[#000080] p-10 rounded-[40px] text-white flex flex-col gap-6 relative overflow-hidden">
               <div className="absolute top-0 right-0 w-32 h-32 bg-[#D4AF37]/20 rounded-bl-[100px]" />
          ...
          <div className="lg:col-span-7">
            <div className="bg-white p-12 rounded-[60px] shadow-sm border border-neutral-100 flex flex-col gap-10">
              <div className="flex flex-col gap-2">
                <h2 className="text-3xl font-bold text-[#000080] uppercase">Send us an enquiry</h2>
              ...
              <form className="flex flex-col gap-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="flex flex-col gap-3">
                    ...
                    <input type="text" className="bg-neutral-50 border border-neutral-100 p-5 rounded-3xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#D4AF37]" placeholder="John" />
                  </div>
                  <div className="flex flex-col gap-3">
                    <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-neutral-400">Last Name</label>
                    <input type="text" className="bg-neutral-50 border border-neutral-100 p-5 rounded-3xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#D4AF37]" placeholder="Doe" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="flex flex-col gap-3">
                    ...
                    <input type="email" className="bg-neutral-50 border border-neutral-100 p-5 rounded-3xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#D4AF37]" placeholder="john@example.com" />
                  </div>
                  <div className="flex flex-col gap-3">
                    <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-neutral-400">Phone Number</label>
                    <input type="tel" className="bg-neutral-50 border border-neutral-100 p-5 rounded-3xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#D4AF37]" placeholder="+255..." />
                  </div>
                </div>

                <div className="flex flex-col gap-3">
                  <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-neutral-400">Reason for enquiry</label>
                  <select className="bg-neutral-50 border border-neutral-100 p-5 rounded-3xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#D4AF37] appearance-none">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <textarea rows={6} className="bg-neutral-50 border border-neutral-100 p-5 rounded-3xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#D4AF37] resize-none" placeholder="Tell us more about your enquiry..." />
                </div>
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <button className="w-full py-6 bg-[#000080] text-white rounded-3xl font-bold uppercase tracking-widest hover:bg-[#D4AF37] transition-all shadow-xl flex items-center justify-center gap-3 group">
                    Send Enquiry
