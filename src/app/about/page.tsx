...
export default function AboutPage() {
  ...
  return (
    <main className="pt-16 bg-[#f6f5f1] min-h-screen font-sans selection:bg-[#000080] selection:text-white">
      {/* Hero */}
      <section className="py-24 px-6 border-b border-neutral-200">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#D4AF37] mb-4 block">ABOUT HBS</span>
            <h1 className="text-4xl md:text-7xl font-bold text-[#000080] uppercase leading-[0.9] mb-8 font-sans">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col gap-12">
            <div className="space-y-6">
              <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#D4AF37]">HUMBLE BEGINNINGS</span>
              <h2 className="text-3xl md:text-5xl font-bold text-[#000080] uppercase">A school built by the community, for the community.</h2>
              <blockquote className="text-2xl font-bold text-[#000080] italic border-l-8 border-[#D4AF37] pl-8 py-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-neutral-600 leading-relaxed font-medium">
              <div className="space-y-6">
                <p>
                  <strong className="text-[#000080] uppercase block mb-2">The problem:</strong>
                ...
                <p>
                  <strong className="text-[#000080] uppercase block mb-2">The first attempt:</strong>
              ...
              <div className="space-y-6">
                <p>
                  <strong className="text-[#000080] uppercase block mb-2">The call to start:</strong>
                ...
                <p>
                  <strong className="text-[#000080] uppercase block mb-2">The same focus, today:</strong>
      ...
      <section className="py-32 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#D4AF37] mb-4 block">WHAT WE OBSESS OVER</span>
            <h2 className="text-4xl md:text-6xl font-bold text-[#000080] uppercase">Three commitments that have never changed.</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-neutral-200 border border-neutral-200 rounded-[40px] overflow-hidden">
            {obsessions.map((obs) => (
              <div key={obs.id} className="bg-white p-12 flex flex-col gap-6 group hover:bg-neutral-50 transition-colors">
                <span className="text-6xl font-bold text-neutral-100 group-hover:text-[#D4AF37]/20 transition-colors">{obs.id}</span>
                <h3 className="text-2xl font-bold text-[#000080]">{obs.title}</h3>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-16">
          <div className="lg:col-span-1">
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#D4AF37] mb-4 block">WHAT GUIDES US</span>
            <h2 className="text-4xl font-bold text-[#000080] uppercase mb-8">Mission, vision, and values.</h2>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-[#000080] p-10 rounded-[40px] text-white">
              <h3 className="text-xl font-bold text-[#D4AF37] uppercase mb-4">01 Our mission</h3>
            ...
            <div className="bg-[#D4AF37] p-10 rounded-[40px] text-white">
              <h3 className="text-xl font-bold text-[#000080] uppercase mb-4">02 Our vision</h3>
            ...
            <div className="bg-white p-10 rounded-[40px] border border-neutral-200 md:col-span-2">
              <h3 className="text-xl font-bold text-[#000080] uppercase mb-6">03 Our values</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {values.map((v, i) => (
                  <div key={i} className="flex flex-col gap-1">
                    <span className="text-lg font-bold text-[#000080]">{v.title}</span>
