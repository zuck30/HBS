      ...
      <div className="max-w-7xl mx-auto">
        <header className="flex justify-between items-end mb-12">
          <div className="flex flex-col gap-2">
            ...
            <h1 className="text-4xl font-bold text-[#44ACFF] uppercase">School Events</h1>
              ...
              <tbody className="divide-y divide-neutral-50">
                 {loading ? (
                    ...
                    <tr key={event.id} className="group hover:bg-neutral-50/50 transition-colors">
                       <td className="px-8 py-6">
                          <div className="flex items-center gap-4">
                             ...
                             <div className="flex flex-col">
                                ...
                                <span className="text-[10px] font-bold text-[#ECB65F] uppercase tracking-widest">Upcoming</span>
                             </div>
                          </div>
                       </td>
                       <td className="px-8 py-6">
                          <div className="flex flex-col gap-1">
                             <span className="text-xs font-bold text-[#44ACFF] uppercase tracking-tight flex items-center gap-2"><CalIcon size={12} /> {new Date(event.date).toLocaleDateString()}</span>
                       ...
                       <td className="px-8 py-6">
                          <span className="text-xs font-medium text-neutral-500 flex items-center gap-2"><MapPin size={14} className="text-[#ECB65F]" /> {event.location}</span>
                       </td>
                       <td className="px-8 py-6">
                          <div className="flex flex-col gap-1">
                             ...
                             <div className="h-1 w-20 bg-neutral-100 rounded-full overflow-hidden">
                                <div className="h-full bg-[#44ACFF]" style={{ width: `${(event.rsvp_count || 0) / (event.capacity || 1) * 100}%` }} />
                             </div>
                          </div>
                       </td>
